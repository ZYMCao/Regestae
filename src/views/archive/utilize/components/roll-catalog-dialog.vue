<template>
  ...
  <el-dialog
    ...
    width="92%"
    top="4vh"
    custom-class="roll-catalog-dialog"
    append-to-body
  >
    <div class="rcd-body">
      <!-- 左侧：档案分类目录 -->
      ...
      <div class="rcd-main">
        ...
        <el-table :data="rows" border size="small" height="340" @selection-change="s => (selection = s)">
          ...
          <el-table-column label="检查情况" prop="checkInfo" width="90" align="center" />
          ...
          <el-table-column label="密级" prop="secret" width="70" align="center" sortable />
          <el-table-column label="档案类型" prop="archiveType" width="90" align="center" sortable />
          <el-table-column label="保存时间" prop="saveTime" width="90" align="center" />
        </el-table>
