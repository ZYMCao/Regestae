...
export function uploadTemporaryAttachment(sessionId: string, file: File, agentId?: string, agentSourceTenantId?: string, parserEngine?: string, onProgress?: (percent: number) => void): Promise<AttachmentResponse> {
	...
	return postUpload<AttachmentResponse>(`/api/v1/sessions/${sessionId}/attachments`, form, (event) => {
