<template>
  ...
  <el-dialog
    ...
    top="4vh"
    custom-class="file-catalog-select-dialog"
    append-to-body
  >
    <template slot="title">
      <div class="fcs-header">
        <span class="fcs-title">添加文件目录</span>
        <i class="el-icon-crop fcs-fullscreen" @click="fullscreen = !fullscreen" />
      </div>
    </template>
